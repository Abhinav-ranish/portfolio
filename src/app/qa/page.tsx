...
export default function ChatPage() {
    ...
    const suggestions = [
        ...
        { label: 'What are his hobbies?', action: () => sendMessage('What are his hobbies?') },
        {
    ...
    return (
        <div className=" max-w-2xl mx-auto flex flex-col">
                ...
                {messages.length > 1 && (
                    <button
                        onClick={() => {
                            ...
                            setMessages([{ sender: 'ai', text: 'Hi, I’m Mr. Robot. How can I help you today?' }])
                        }}
            ...
            {showProjectSelector && (
                <div className="p-4 bg-gray-800 space-y-2">
                    ...
                    <select
                        ...
                        onChange={(e) => {
                            const sel = projectOptions.find((o) => o.label === e.target.value)
                            if (sel) {
                                sendMessage(`Give me more details about ${sel.label}`, sel.context)
                                setShowProjectSelector(false)
            ...
            {showWorkSelector && (
                <div className="p-4 bg-gray-800 space-y-2">
                    <label className="block text-gray-200">Select a work experience:</label>
                    <select
            ...
            <div className="flex-1 overflow-hidden flex flex-col max-h-[calc(100vh-200px)]">
                ...
                <div className="flex justify-end gap-2 mt-2">
                    <button onClick={downloadTxt} className="text-sm bg-gray-700 text-white px-3 py-1 rounded hover:bg-gray-600">
                        Save as .txt
                    </button>
                    <button onClick={downloadPdf} className="text-sm bg-gray-700 text-white px-3 py-1 rounded hover:bg-gray-600">
                        Save as PDF
                    </button>
                </div>
